...
# Uncomment next line.
ROOT_DIR=/gs/hs0/tga-shinoda/18B11396/sound-separation/data
...
DEV_DATA_DIR=${ROOT_DIR}/Noise_Voice_Independent
DISC_DATA_DIR=${ROOT_DIR}/Noise_Voice_Independent
...
RAW_DATA_DIR=${ROOT_DIR}/Voice_Splited
NUM_MAX_MIX=2
NOISE_DIR=${ROOT_DIR}/Monoral_Isolated_urban_sound/background2
